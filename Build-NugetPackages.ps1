...
try {
    ...
    Build-Nuget "Microsoft.ServiceFabricApps.FabricObserver.Linux.SelfContained_SF8x" "$scriptPath\bin\release\FabricObserver\linux-x64\self-contained\FabricObserverType" "FabricObserver.nuspec.template"
    Build-Nuget "Microsoft.ServiceFabricApps.FabricObserver.Linux.FrameworkDependent_SF8x" "$scriptPath\bin\release\FabricObserver\linux-x64\framework-dependent\FabricObserverType" "FabricObserver.nuspec.template"

    Build-Nuget "Microsoft.ServiceFabricApps.FabricObserver.Windows.SelfContained_SF8x" "$scriptPath\bin\release\FabricObserver\win-x64\self-contained\FabricObserverType" "FabricObserver.nuspec.template"
    Build-Nuget "Microsoft.ServiceFabricApps.FabricObserver.Windows.FrameworkDependent_SF8x" "$scriptPath\bin\release\FabricObserver\win-x64\framework-dependent\FabricObserverType" "FabricObserver.nuspec.template"
