...
**Note: You must deploy this version (3.2.8) to clusters that are running SF 9.0 and above. This version also requires .NET 6.**
...
New-ServiceFabricApplication -ApplicationName fabric:/FabricObserver -ApplicationTypeName FabricObserverType -ApplicationTypeVersion 3.2.8   
...
Start-ServiceFabricApplicationUpgrade -ApplicationName fabric:/FabricObserver -ApplicationTypeVersion 3.2.8 -Monitored -FailureAction rollback
```  
