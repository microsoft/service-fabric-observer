...
**The uber goal here is to greatly reduce the complexity of host OS, Service Fabric infrastructure, and Servcice Fabric app health monitoring**. For SF app developers, it's as easy as supplying some simple configuration files (JSON and XML).
