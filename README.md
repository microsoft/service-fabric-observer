...
**Note: You must deploy this version (3.2.2.960) to clusters that are running SF 9.0 and above. This version also requires .NET 6.**
...
Start-ServiceFabricApplicationUpgrade -ApplicationName fabric:/FabricObserver -ApplicationTypeVersion 3.2.2.960 -Monitored -FailureAction rollback
```  
