...
### Important: Requires SF Runtime 8.0 and above
...
This feature is disabled by default. If you have AppObserver or ContainerObserver configured to monitor lots of services, then you should enable this feature. You can enable/disable with parameter-only, versionless application upgrades with the related settings found in ApplicationManifest.xml under the AppObserver, ContainerObserver and FabricSystemObserver settings sections.
