# FabricObserver 3.0.0-preview-1 - NET Core 3.1
...
2. Runs on [multiple versions of Windows Server and various Linux distros](https://github.com/dotnet/core/blob/master/release-notes/3.1/3.1-supported-os.md) 
3. Suppports an easy-to-use extensibility model for creating custom Observers out of band (so, you don't need to clone the repo to build an Observer).
