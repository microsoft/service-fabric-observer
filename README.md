...
**Note: You must deploy this version (3.2.7) to clusters that are running SF 9.0 and above. This version also requires .NET 6.**
...
Register-ServiceFabricApplicationType -ApplicationPathInImageStore FO327

#Create FO application (if not already deployed at lesser version):

New-ServiceFabricApplication -ApplicationName fabric:/FabricObserver -ApplicationTypeName FabricObserverType -ApplicationTypeVersion 3.2.7   
...
Start-ServiceFabricApplicationUpgrade -ApplicationName fabric:/FabricObserver -ApplicationTypeVersion 3.2.7 -Monitored -FailureAction rollback
```  
