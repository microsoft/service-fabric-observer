...
**After this release, there will only be .NET 6 (and higher) supported versions of FabricObserver. Version naming will change to x.x.x format and there will only be 1 release version.**
