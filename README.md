...
1. Monitors a broad range of physical machine resources that tend to be very important to Service Fabric services and nodes and maps these metrics to the related Service Fabric entities.
...
Copy-ServiceFabricApplicationPackage -ApplicationPackagePath $path -CompressPackage -ApplicationPackagePathInImageStore FO326 -TimeoutSec 1800

#Register FO ApplicationType:

Register-ServiceFabricApplicationType -ApplicationPathInImageStore FO326
