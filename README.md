...
(The [net6](https://github.com/microsoft/service-fabric-observer/tree/net6) branch houses the version for .NET 6 and SF Runtime >= 9.0)
...
**Note: You must deploy this version (3.2.0.831) to clusters that are running SF 8.0 and above. This version also requires .NET Core 3.1.**
...
Start-ServiceFabricApplicationUpgrade -ApplicationName fabric:/FabricObserver -ApplicationTypeVersion 3.2.0.831 -Monitored -FailureAction rollback
```  
