...
| Looks for dmp files in observer log directories to compress (optimal) and upload to your specified Azure storage account (blob only and still Windows only in this version of FO) | AzureStorageObserver |
