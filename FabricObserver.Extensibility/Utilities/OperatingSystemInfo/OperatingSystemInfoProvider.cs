...
namespace FabricObserver.Observers.Utilities
{
    public abstract class OSInfoProvider
    {
        ...
        public abstract int GetActiveTcpPortCount(uint processId = 0, string configPath = null);
        ...
        /// If supplied, will use the path to find the Linux Capabilities binary to run this command.</param>
        /// <returns>Number of active TCP ports in use as integer value.</returns>
        public abstract int GetActiveEphemeralPortCount(uint processId = 0, string configPath = null);
        ...
        public abstract double GetActiveEphemeralPortCountPercentage(uint processId = 0, string configPath = null);
    }
}
