...
{
    public sealed class ErrorWarningCodes
    {
        public static Dictionary<string, string> AppErrorCodesDictionary { get; private set; }

        public static Dictionary<string, string> NodeErrorCodesDictionary { get; private set; }
        ...
        static ErrorWarningCodes()
        {
            AppErrorCodesDictionary = new Dictionary<string, string>
            {
                { Ok, "Ok" },
            ...
            NodeErrorCodesDictionary = new Dictionary<string, string>
            {
                { Ok, "Ok" },
