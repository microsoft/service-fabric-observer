## FabricObserver Extensibility Library 3.3.2 (NET 8, SF Runtime version 10.0 and higher)
...
Note: Version 3.3.2 supports SF Runtime versions 10.0 and higher. It can not be used for lesser versions.

### How to implement an observer using FO's extensibility model

1. Create a new .NET core library project. You should target net8.0 in your csproj because that is the target net SDK version that FabricObserver 3.3.2 is built for.
