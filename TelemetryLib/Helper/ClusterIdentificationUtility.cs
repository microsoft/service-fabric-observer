...
namespace Microsoft.ServiceFabric.TelemetryLib.Helper
{
    ...
    public class ClusterIdentificationUtility: IDisposable
    {
        ...
        public void GetClusterIdAndType(out string clusterId, out string tenantId, out string clusterType)
        {
            ...
            if (tenantId != TelemetryConstants.Undefined)
            {
                clusterId = tenantId;
            ...
            if (this.diagnosticsClusterId != null)
            {
