...
{
    /// <summary>
    /// FabricObserver Error and Warning Codes related to machine resource usage metrics at the machine and service levels.
    /// </summary>
    public sealed class SupportedErrorCodes
    {
        ...
        public static string GetErrorWarningNameFromFOCode(string code)
        {
