...
#### Requires SF Runtime 8.x

ClusterObserver (CO) is a stateless singleton Service Fabric .Net Core 3.1 service that runs on one node in a cluster. CO observes cluster health (aggregated) 
