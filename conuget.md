...
```Powershell
Start-ServiceFabricApplicationUpgrade -ApplicationName fabric:/ClusterObserver -ApplicationTypeVersion 2.3.2 -ApplicationParameter $appParams -Monitored -FailureAction rollback
```
