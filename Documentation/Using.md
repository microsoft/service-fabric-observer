...
```Powershell
Start-ServiceFabricApplicationUpgrade -ApplicationName fabric:/FabricObserver -ApplicationTypeVersion 3.2.3.960 -ApplicationParameter $appParams -Monitored -FailureAction rollback
```  
