...
```Powershell
Start-ServiceFabricApplicationUpgrade -ApplicationName fabric:/FabricObserver -ApplicationTypeVersion 3.2.0 -ApplicationParameter $appParams -Monitored -FailureAction rollback
```  
