...
```Powershell
Start-ServiceFabricApplicationUpgrade -ApplicationName fabric:/FabricObserver -ApplicationTypeVersion 3.1.23 -ApplicationParameter $appParams -Monitored -FailureAction rollback
```  
