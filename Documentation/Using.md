...
```Powershell
Start-ServiceFabricApplicationUpgrade -ApplicationName fabric:/FabricObserver -ApplicationTypeVersion 3.1.19 -ApplicationParameter $appParams -Monitored -FailureAction rollback
```  
