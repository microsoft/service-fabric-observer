...
```Powershell
Start-ServiceFabricApplicationUpgrade -ApplicationName fabric:/FabricObserver -ApplicationTypeVersion 3.1.26 -ApplicationParameter $appParams -Monitored -FailureAction rollback
```  
