...
```Powershell
Start-ServiceFabricApplicationUpgrade -ApplicationName fabric:/FabricObserver -ApplicationTypeVersion 3.2.8.31 -ApplicationParameter $appParams -Monitored -FailureAction rollback
```  
