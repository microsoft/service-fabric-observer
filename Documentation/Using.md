...
```Powershell
Start-ServiceFabricApplicationUpgrade -ApplicationName fabric:/FabricObserver -ApplicationTypeVersion 3.1.24 -ApplicationParameter $appParams -Monitored -FailureAction rollback
```  
