...
```Powershell
Start-ServiceFabricApplicationUpgrade -ApplicationName fabric:/FabricObserver -ApplicationTypeVersion 3.1.25 -ApplicationParameter $appParams -Monitored -FailureAction rollback
```  
