...
```Powershell
Start-ServiceFabricApplicationUpgrade -ApplicationName fabric:/FabricObserver -ApplicationTypeVersion 3.1.20 -ApplicationParameter $appParams -Monitored -FailureAction rollback
```  
