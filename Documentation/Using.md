...
```Powershell
Start-ServiceFabricApplicationUpgrade -ApplicationName fabric:/FabricObserver -ApplicationTypeVersion 3.2.9 -ApplicationParameter $appParams -Monitored -FailureAction rollback
```  
