...
Start-ServiceFabricApplicationUpgrade -ApplicationName fabric:/FabricObserver -ApplicationParameter $appParams -ApplicationTypeVersion 3.3.3 -UnMonitoredAuto
...
```JSON
  {
    ...
    "Timestamp": "2024-08-06T02:45:28.9827940Z",
    "OS": "Windows",
